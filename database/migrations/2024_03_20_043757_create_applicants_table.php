...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('applicants', function (Blueprint $table) {
            ...
            $table->string('application_number');           //ใบสมัครเลขที่
            $table->string('photo');                        //รูปถ่าย
            $table->string('prefix');                       //คำนำหน้าชื่อ
            $table->string('first_name');                   //ชื่อ
            $table->string('last_name');                    //นามสกุล
            $table->string('position');                     //สมัครตำแหน่ง
            $table->string('address');                      //ที่อยู่
            $table->date('birthdate');                      //วันเดือนปีเกิด
            $table->string('age');                          //อายุ
            $table->string('phone');                        //หมายเลขโทรศัพท์
            $table->string('birthplace');                   //สถานที่เกิด
            ...
            $table->string('card_issued_date');             //วันเดือนปีที่ออกบัตร
            $table->string('expiration_date');              //วันเดือนปีที่บัตรหมดอายุ
